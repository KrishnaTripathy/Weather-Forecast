...
const Forecast = ({ data }) => {
  ...
  const getDateForForecast = (forecastIdx) => {
    const currentDate = new Date();
    currentDate.setDate(currentDate.getDate() + forecastIdx + 1);
            ...
            <AccordionItemHeading>
              <AccordionItemButton>
                <div className="daily-item">
                  ...
                  <label className="date">{getDateForForecast(idx)}</label>
                ...
                <label className="average-temp">
                  Avg Temp:
                  {calculateAverageTemperature(data.list.slice(idx, idx + 5))}°C
                </label>
              </AccordionItemButton>
            </AccordionItemHeading>
            <AccordionItemPanel>
              <div className="daily-details-grid">
                ...
                <div className="daily-details-grid-item">
                  ...
                  <label>{item.wind.deg} km/h</label>
                </div>
                <div className="daily-details-grid-item">
